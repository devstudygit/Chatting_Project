            ...
            <div className="d-flex w-100 justify-content-center pb-5">
                <div className="col-2 d-flex justify-content-center">
                    <div className="border-radius-sm rounded-circle border-2 border border-dark" style={{height: "45px", width: "45px" }}>
                        <a href="http://127.0.0.1:8080/oauth2/authorization/naver" id="naver" className="link-image">
                ...
                <div className="col-2 d-flex justify-content-center">
                    <div className="border-radius-sm rounded-circle border-2 border border-dark" style={{height: "45px", width: "45px" }} >
                        <a href="http://127.0.0.1:8080/oauth2/authorization/kakao" id="kakao" className="link-image">
